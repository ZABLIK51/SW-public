...
medieval-ancient-nocturne-round-end-did-not-survive = - { roles-antag-ancient-nocturne-name } { $name }: не дожил до конца
medieval-ancient-nocturne-round-end-blood-collected = - { roles-antag-ancient-nocturne-name } { $name }: собрано крови в кровавом рубине — { $amount }
medieval-ancient-nocturne-round-end-ruby-lost = - { roles-antag-ancient-nocturne-name } { $name }: Потерял свой рубин
medieval-ancient-nocturne-round-end-unknown-name = без имени
